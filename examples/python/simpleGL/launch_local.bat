...
set APP_ARGS=D:\tools\pythonlibs\simpleGL\simpleGL.py D:\tools\vrjuggler-config\desktop\desktop-cavesim.jconf
set APP_WORKDIR=D:\tools\pythonlibs\simpleGL
SET LOG_NAME=runlog-master.txt

rem set dependency DLL paths
set PATH=D:\tools\boost_1_55_0\lib64-msvc-12.0;%PATH%
set PATH=D:\tools\freealut\bin;%PATH%
set PATH=D:\tools\openal\bin;%PATH%x
