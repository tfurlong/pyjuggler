...
struct vrj_OpenSGApp_Wrapper : vrj::OpenSGApp
{
   ...
   OSG::NodePtr getScene()
   {
      ...
      try
      {
         return call_method<OSG::NodePtr>(self, "getScene");
      }
      catch (error_already_set)
      {
         PyErr_Print();
   ...
   bool configCanHandle(jccl::ConfigElementPtr p0)
   {
      ...
      try
      {
         return call_method<bool>(self, "configCanHandle");
      }
      catch (error_already_set)
      {
         PyErr_Print();
   ...
   bool configAdd(jccl::ConfigElementPtr p0)
   {
      ...
      try
      {
         return call_method<bool>(self, "configAdd");
      }
      catch (error_already_set)
      {
         PyErr_Print();
   ...
   bool configRemove(jccl::ConfigElementPtr p0)
   {
      ...
      try
      {
         return call_method<bool>(self, "configRemove");
      }
      catch (error_already_set)
      {
         PyErr_Print();
...
void _Export_OpenSGApp()
{
   ...
   class_<vrj::OpenSGApp, bases<vrj::GlApp>, boost::noncopyable,
          pyj::vrj_OpenSGApp_Wrapper>
      ("OpenSGApp",
